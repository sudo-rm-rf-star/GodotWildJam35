...
onready var _slider: HSlider = $CenterContainer/PanelContainer/MarginContainer/VBoxContainer/HSlider


func init(new_machine_name: String, influence: float):
	machine_name = new_machine_name
	_name_label.text = machine_name
	_slider.value = influence
